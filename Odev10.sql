...
--   birlikte görebileceğimiz LEFT INNER JOIN sorgusunu yazınız.
SELECT city.city, country.country
FROM city
LEFT JOIN country ON city.country_id = country.country_id;
-- 2.customer tablosu ile payment tablosunda bulunan payment_id ile customer tablosundaki 
--   first_name ve last_name isimlerini birlikte görebileceğimiz RIGHT INNER JOIN sorgusunu yazınız.
...
--   last_name isimlerini birlikte görebileceğimiz FULL INNER JOIN sorgusunu yazınız.
